    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <form action="{{route('admin_salas_cadastrar')}}" method="post" class = "d-flex flex-column justify-content-center align-items-center" >
                    @csrf
                    <div class="row">
                        ...
                        <label class = "mt-4 ">Categoria do laboratório</label>
