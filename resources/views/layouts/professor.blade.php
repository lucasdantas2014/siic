...
<head>
    ...
    <<meta charset="utf-8">
    <!-- Scripts -->
    <script src="{{ asset('professor/js/app.js') }}" defer></script>
    <!-- Styles -->
    <link href="{{ asset('professor/css/app.css') }}" rel="stylesheet">
...
<div class="container border"  id = "header" style = "width:998px;background-image:url(background.png);">
    <div class="row" style = "width:100%;">
        <div class = "col-2">
            <img src="{{asset('professor/logo_campus.png')}}" class = "p-3">
        </div>
